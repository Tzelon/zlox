...
pub fn disassembleInstruction(chunk: *Chunk, offset: usize) usize {
    ...
    return switch (instruction) {
        ...
        OpCode.OP_GET_SUPER => constantInstruction("OP_GET_SUPER", chunk, offset),
        OpCode.OP_INHERIT => simpleInstruction("OP_INHERIT", offset),
        OpCode.OP_INVOKE => invokeInstruction("OP_INVOKE", chunk, offset),
        OpCode.OP_SUPER_INVOKE => invokeInstruction("OP_SUPER_INVOKE", chunk, offset),
